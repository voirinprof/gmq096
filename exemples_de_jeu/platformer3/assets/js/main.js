...
function create () // create method
{
    ...
    platforms.create(600, 1650, "platform");
    platforms.create(50, 1350, "platform");
    platforms.create(650, 1420, "platform");
    platforms.create(250, 15520, "platform");
    // the ground
    for (var i=0;i<30;i++) {
        platforms.create(10+i*63, 1780, "platform"); // this is a loop to create the platforms
    }
    ...
    // define the player
    player = this.physics.add.sprite(380, 1500, "player1").play('idle');
    ...
    this.cameras.main.setBounds(0, 0, 800, 1800); // inside the bounds of the world
    
}


function update (time, delta) // update method
{
    ...
    if (cursors.left.isDown) {
      ...
      // move the camera 
      this.cameras.main.scrollY = 1400 - time/30;
